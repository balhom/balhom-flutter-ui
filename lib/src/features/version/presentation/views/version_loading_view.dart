...
class _VersionLoadingViewState extends ConsumerState<VersionLoadingView> {
  ...
  Widget build(BuildContext context) {
    ...
    final versionState = ref.watch(versionUseCase);

    return AppScaffold(
        body: versionState.when<Widget>(data: (final appVersion) {
      ...
      return showError(
          icon: Icons.network_wifi_1_bar, text: appLocalizations.wrongVersion);
    }, error: (error, _) {
