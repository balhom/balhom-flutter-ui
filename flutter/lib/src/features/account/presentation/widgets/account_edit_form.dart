...
import 'package:balance_home_app/src/features/account/presentation/utils/dialog_utils.dart';
...
import 'package:balance_home_app/src/features/currency/presentation/utils/dialog_utils.dart';
              ...
              child: Column(
                children: [
                  ...
                  DoubleFormField(
                    ...
                    validator: (value) => accountEditValuesDto!
                        .expectedAnnualBalanceValue.validate,
                    maxWidth: 300,
                  ...
                  (currencyTypes.isNotEmpty)
                      ? DropdownPickerField(
                          ...
                          onChanged: (newCurrencyType) =>
                              changePrefCurrencyType(
                                  newCurrencyType!,
